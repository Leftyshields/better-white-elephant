        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold">StealOrReveal.com</h3>
                <p className="text-sm text-gray-400">A Better White Elephant Gift Exchange</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <a 
                ...
                className="flex items-center gap-2 bg-gray-700/50 border border-gray-600/50 rounded-lg px-4 py-2 hover:bg-gray-700 transition-colors"
              >
